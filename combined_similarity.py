...
if __name__ == "__main__":
    ...
    average_similarity = (spacy_similarity + synonym_similarity) / 2
    
    print("Similarity using spaCy:", spacy_similarity)
    print("Similarity using synonyms:", synonym_similarity)
